...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "createProject.sourceFolder": "Source folder",
    "createProject.addFolderHint": "Add a folder on this computer",
    "createProject.add": "Add",
    "createProject.changeFolder": "Change folder",
    "createProject.browseInApp": "Browse in app",
    "createProject.chooseFolderPrompt": "Select project folder",
    ...
    "sidebar.archiveSession": "Archive conversation",
    "sidebar.unarchiveSession": "Unarchive conversation",
    "sidebar.deleteProject": "Delete project",
    "projectDelete.title": "Delete project?",
    "projectDelete.body": "This permanently deletes \u201c{name}\u201d and its {count} conversation(s), including all subagents. This cannot be undone.",
    "projectDelete.confirm": "Delete project",
    "projectDelete.deleting": "Deleting\u2026",
