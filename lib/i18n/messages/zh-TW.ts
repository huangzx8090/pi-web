...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.projects": "專案",
    "sidebar.recent": "最近",
    "sidebar.showMore": "展開顯示",
    "sidebar.showMoreCount": "展開其餘 {count} 個",
    "sidebar.showLess": "收合",
    "sidebar.pinned": "置頂",
    "sidebar.pin": "置頂",
    "sidebar.unpin": "取消置頂",
    ...
    "createProject.sourceFolder": "來源資料夾",
    "createProject.addFolderHint": "在此電腦上新增資料夾",
    "createProject.add": "新增",
    "createProject.changeFolder": "更換資料夾",
    "createProject.browseInApp": "應用程式內瀏覽",
    "createProject.chooseFolderPrompt": "選擇專案資料夾",
    "sidebar.archived": "已封存",
    "archive.empty": "暫無封存內容",
    "archive.conversations": "對話",
    "sidebar.archiveProject": "封存專案",
    "sidebar.unarchiveProject": "取消封存專案",
    "sidebar.archiveSession": "封存對話",
    "sidebar.unarchiveSession": "取消封存對話",
    "sidebar.deleteProject": "刪除專案",
    "projectDelete.title": "刪除專案？",
    "projectDelete.body": "將永久刪除「{name}」及其 {count} 個對話（含子代理），此操作無法復原。",
    "projectDelete.confirm": "刪除專案",
    "projectDelete.deleting": "刪除中…",
    "createProject.create": "建立專案",
