...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.showMoreCount": "展开其余 {count} 个",
    "sidebar.showLess": "收起",
    "sidebar.pinned": "置顶",
    "sidebar.pin": "置顶",
    "sidebar.unpin": "取消置顶",
    ...
    "createProject.sourceFolder": "源文件夹",
    "createProject.addFolderHint": "在此电脑上添加文件夹",
    "createProject.add": "添加",
    "createProject.changeFolder": "更换文件夹",
    "createProject.browseInApp": "应用内浏览",
    "createProject.chooseFolderPrompt": "选择项目文件夹",
    "sidebar.archived": "已归档",
    "archive.empty": "暂无归档内容",
    "archive.conversations": "对话",
    "sidebar.archiveProject": "归档项目",
    "sidebar.unarchiveProject": "取消归档项目",
    "sidebar.archiveSession": "归档对话",
    "sidebar.unarchiveSession": "取消归档对话",
    "sidebar.deleteProject": "删除项目",
    "projectDelete.title": "删除项目？",
    "projectDelete.body": "将永久删除“{name}”及其 {count} 个对话（含子智能体），此操作无法撤销。",
    "projectDelete.confirm": "删除项目",
    "projectDelete.deleting": "删除中…",
